...
import type { BrandDocument, EventDocument } from "@brayford/core";
import { getScopeLabel, type SceneWithId } from "@/hooks/use-scenes-page-data";
    ...
    return (
      <div className="bg-white rounded-lg shadow-md p-12 text-center">
        ...
        <h3 className="text-xl font-semibold text-gray-900 mb-2">
          {hasFilters ? "No scenes found" : "No scenes yet"}
        </h3>
        ...
        >
          <div className="p-6">
            ...
            <div className="flex items-center text-xs text-gray-500">
              ...
              {getScopeLabel(scene, brands, events)}
            </div>
          </div>
        </div>
      ))}
